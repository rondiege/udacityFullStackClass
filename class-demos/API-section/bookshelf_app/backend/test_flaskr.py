...
class BookTestCase(unittest.TestCase):
    ...
    def test_update_book_rating(self):
        ...
        # better to put a new book in there then change it, then suppose that this is in there
        # print('----------')
        # print(res)
        # print('----------')
        data = json.loads(res.data)
    ...
    def test_delete_book(self):
        ...
        book_id = json.loads(res.data)['created']
        # print(book_id)
    ...
    def test_404_if_book_does_not_exist(self):
        ...
        self.assertEqual(data['success'], False)
        self.assertEqual(data['message'], '422 Unprocessable Entity: Unprocessable')
